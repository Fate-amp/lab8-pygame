...
### 08-04-2026 22:07
- **Prompt**: right now I'm getting this error that Vector2 has no attribute norm()
...
### 08-04-2026 22:18
- **Prompt**: Now the questions: 1. When they have the same center, the distance would be 0, but in what case would that happen? and how do i prevent it Question 3: I should check whether the magnitude of the vector  is not 0
...
### 13-04-2026 21:43
- **Prompt**: Append a new entry at the end of JOURNAL.md for the prompt: "Okay here's what I've gathered from what you said. Correct me if I'm wrong. I should create a MIN_LIFESPAN and MAX_LIFESPAN in the constants and for every square, I add a lifespan attribute randomly. I also add a remaining_life attribute which is updated with every update and if it's 0, the square is removed. What I don't understand is:1. How do I cleanly remove a square when it's dead? 2. To catch the remaining_life, do I use the substraction time stamps? Or is there a better way that I'm not seeing?" Timestamp 13-04-2026. Note that this interaction provided conceptual guidance only; no code changes were made. Keep existing template and chronological order.

### 15-04-2026 12:05
- **Prompt**: Where do I create a new survivors list? Help me understand by asking me questions

### 15-04-2026 12:05
- **Prompt**: Append a new entry at the end of JOURNAL.md for the prompt: "Where do I create a new survivors list? Help me understand by asking me questions" with timestamp 15-04-2026. Note that no code changes were made; provided Socratic guidance questions about where to create and rebuild a survivors list in the main loop. Preserve existing template and chronological order.
...
### 15-04-2026 16:53
- **Prompt**: so here's my guess: I update each square, then create a survivors list, then for every square that's dead, I create a new one using the class. Explain to me if anything is wrong in this logic
...
### 15-04-2026 17:43
- **Prompt**: I tried fixing it. review my code again and tell me what I can improve
...
### 16-04-2026 15:57
- **Prompt**: I know that the time complexity is n^2. I think I should only care about the nearby squares, but how do I see the nearby squares without comparing everything? Do I compare the x and y values and if they're less than a certain amount, I start going through the square? Help me understand how I can prevent that from happening
...
### 16-04-2026 17:01
- **Prompt**: I tried to implement what you asked, review my code and help me understand why it's not working

### 16-04-2026 17:01
- **Prompt**: Append a new entry at the end of JOURNAL.md for the prompt: "I tried to implement what you asked, review my code and help me understand why it's not working" with timestamp 16-04-2026. Note no code changes; identified and explained bugs in the user's Vector2 optimization attempt. Preserve existing template and chronological order.

### 16-04-2026 17:07
- **Prompt**: I fixed those bugs but the squares are now overlapping ALOT. Something is still off
...
### 03-05-2026 21:49
- **Prompt**: explain to me why the squares are catching up to eachother and how i can prevent that, in theory
...
### 11-05-2026 18:34
- **Prompt**: check it again and tell me if it's solved

### 11-05-2026 18:35
- **Prompt**: now check again
...
### 11-05-2026 18:50
- **Prompt**: are all the requirements of this file met?
